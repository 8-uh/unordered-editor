...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = TextEditor = (function(superClass) {
	  ...
	  TextEditor.prototype.componentWillReceiveProps = function(props) {
	    var cursorHeight, cursorWidth, cursorX, cursorY, offsetHeight, offsetWidth, ref1, ref2, scrollLeft, scrollTop;
	    cursorX = props.cursorX, cursorY = props.cursorY, cursorHeight = props.cursorHeight, cursorWidth = props.cursorWidth;
	    ...
	    ref2 = this.refs.editorWrapper, scrollLeft = ref2.scrollLeft, offsetWidth = ref2.offsetWidth;
	    ...
	    if (cursorX < this.refs.editorWrapper.scrollLeft) {
	      return this.refs.editorWrapper.scrollLeft = 0;
	    }
	  };
