...
var UnorderedEditor = function (_Component) {
  ...
  function UnorderedEditor(props) {
    ...
    _this._buffer = new _buffer2.default();
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setInputStyle = function (style) {
    _this2._hiddenInputStyle = style;
  };
  ...
  this.addInputChangeListener = function (listener) {
    _this2._inputChangeListeners = _this2._inputChangeListeners.concat(listener);
  };

  this.addInputKeyDownListener = function (listener) {
    _this2._inputKeyDownListeners = _this2._inputKeyDownListeners.concat(listener);
  };

  this.addInputKeyUpListener = function (listener) {
    _this2._inputKeyUpListeners = _this2._inputKeyUpListeners.concat(listener);
  };

  this.addEditorMouseDownListener = function (listener) {
    _this2._editorMouseDownListeners = _this2._editorMouseDownListeners.concat(listener);
  };

  this.addEditorMouseUpListener = function (listener) {
    _this2._editorMouseUpListeners = _this2._editorMouseUpListeners.concat(listener);
  };
